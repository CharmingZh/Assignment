...
for i in range(len(divRegion)):
    ...
    for j in range(len(d)):
        ...
        print("mean[" + str(i) + "]  += texture2D(texture, (fc + offset[" + str(idx) + "]) * Frag).rgb * weight[" + str(
            idx) + "];")
        print("sigma[" + str(i) + "]  += texture2D(texture, (fc + offset[" + str(
            idx) + "]) * Frag).rgb * texture2D(texture, (fc + offset[" + str(idx) + "]) * Frag).rgb * weight[" + str(
            idx) + "];")
