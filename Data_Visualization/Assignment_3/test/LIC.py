        ...
        for i in range(1, self.M):
            ...
            if iFwdLeft >= 0 and iFwdRight < l:
                ...
                if self.chkBoundary(xFwdLeft) and self.chkBoundary(xFwdRight):
                    IxFwd[0] += float(self.image[xFwdRight.data[1], xFwdRight.data[0], 0] - self.image[
                        xFwdLeft.data[1], xFwdLeft.data[0], 0]) / k
                    IxFwd[1] += float(self.image[xFwdRight.data[1], xFwdRight.data[0], 1] - self.image[
                        xFwdLeft.data[1], xFwdLeft.data[0], 1]) / k
                    IxFwd[2] += float(self.image[xFwdRight.data[1], xFwdRight.data[0], 2] - self.image[
                        xFwdLeft.data[1], xFwdLeft.data[0], 2]) / k
            ...
            if iBwdRight >= 0 and iBwdLeft < l:
                ...
                if self.chkBoundary(xBwdLeft) and self.chkBoundary(xBwdRight):
                    IxBwd[0] += float(self.image[xBwdRight.data[1], xBwdRight.data[0], 0] - self.image[
                        xBwdLeft.data[1], xBwdLeft.data[0], 0]) / k
                    IxBwd[1] += float(self.image[xBwdRight.data[1], xBwdRight.data[0], 1] - self.image[
                        xBwdLeft.data[1], xBwdLeft.data[0], 1]) / k
                    IxBwd[2] += float(self.image[xBwdRight.data[1], xBwdRight.data[0], 2] - self.image[
                        xBwdLeft.data[1], xBwdLeft.data[0], 2]) / k
