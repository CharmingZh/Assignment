...
\documentclass[10pt, a4paper, twocolumn, utf8]{article} % 10pt font size (11 and 12 also possible), A4 paper (letterpaper for US letter) and two column layout (remove for one column)
...
% 当有多个作者的时候，请使用如下代码
\author{
	\authorstyle{John Marston\textsuperscript{1,2,3} and Bonnie MacFarlane\textsuperscript{2,3}} % 论文作者
	\newline\newline % Space before institutions
	\textsuperscript{1}\institution{Universidad Nacional Autónoma de México, Mexico City, Mexico}\\ % 机构 1
	\textsuperscript{2}\institution{University of Texas at Austin, Texas, United States of America}\\ % 机构 2
	\textsuperscript{3}\institution{\texttt{LaTeXTemplates.com}} % 机构 3
}

% 当作者只有一人的时候，请使用如下代码
%\author{\newauthor{John Marston} \newinstitution{Universidad Nacional Autónoma de México, Mexico City, Mexico}}

\date{\today} % 在标题下现实当前时间，加入\today显示，如果置空即不显示
...
\lettrineabstract{中文测试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊试中文测试我是中文啊阿啊阿啊阿啊阿啊你看看我行不行}
